...
Fields:
 ...
 - `facebook`: Type: Object. Optional. Contains information about the institution's facebook page, if our facebook app is subscribed to it. Subfields:
   - `pageId` Type: String. Required. Default value: ''. The id facebook attaches to the relevant page; you can see this on the “About” part of the page (visible only if you have a role on the page). We use this to identify the messaging service of incoming facebook messages.
   - `pageAccessToken` Type: String. Required. Default value: ''. A token generated by facebook for us to identify ourselves with, when we want to do something on behalf of a page, such as send messages.
