SimpleSchema.messages({
  ...
  invalidCollegeEvent: "Please choose a valid college event.",
...
var fieldDefs = {
  ...
  race: {
    ...
    allowedValues: ["American Indian/Alaskan Native", "Asian", "Black/African-American", "Hispanic/Latino", "Native Hawaiian/ Pacific Islander", "White", "I'd rather not share"],
  },
  gender: {
    type: String,
  ...
  activity_type: {
    type: String,
    allowedValues: ["Employment", "Volunteerism", "Extracurricular activity", "Athletics"]
  },
  class_rank_type: {
    type: String,
  ...
  graduated_year: { type: Number, min: new Date().getFullYear() - 80, max: new Date().getFullYear() + 20 },
