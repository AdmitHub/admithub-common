SimpleSchema.messages({
  ...
  dateStringInvalid: "Your response appears to not be in the expected format.",
...
var fieldDefs = {
  ...
  dateString: {
    type: String, 
    custom: function () {
      console.log("inside datestring this\n", this)
      if (/^[0,1]\d\/[0-3]\d\/(19|20)\d{2}$/.test(this.value)) {
        return true;
      } else {
        return "dateStringInvalid"
      }
    }
  },
  yearString: {
