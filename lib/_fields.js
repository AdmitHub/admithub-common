...
var fieldDefs = {
  ...
  attending: {
    type: String,
    allowedValues: ["attending", "not attending", "unsure"]
  },
  parental_situation: {
    type: String,
  ...
  expected_graduation_year: { type: Number, min: new Date().getFullYear() - 10, max: new Date().getFullYear() + 20 },
  zip_code: {
    type: String,
    min: 5,
    max: 10,
  ...
  status: {
    type: String,
    allowedValues: ["Admit", "Admit: Withdrawn", "Applicant: Complete", "Applicant: Denied", "Applicant: Incomplete", "Applicant: Wait list", "Enrolled", "Suspect", "Confirmed", "Applicant: Defer", "Applicant: Withdrawn", "Prospect","Applicant: Wait List Denied", "Applicant: Wait List Declined", "Applicant: Success Academy", "Admit: Declined", "Unknown"]
  },
  student_type: {
    type: String,
