...
const neither = ['not sure'] // This is interpreted as 'yes' without a special case
var yesPrimary = ['yes', 'yeah', 'y', 'ya', 'yea', 'yup', 'yep', 'true', 'sure', 'gladly', 'totally', 'totes', 'got it', 'ok', 'k', 'kk', 'umkay', 'sounds good', 'indeed', 'no problem', 'not a problem', 'okay', 'yess', 'yesss', 'yas', 'good', 'so far, so good', 'so far so good', 'of course']
...
var yesSecondary = ['right', 'cool', 'definitely', 'def', 'defs', 'certainly', 'absolutely', 'ready']
var noSecondary = ['not']
