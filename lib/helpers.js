...
var yesPrimary = ["yes", "yeah", "y", "ya", "yea", "yup", "yep", "true", "sure", "gladly", "absolutely", "totally", "totes", "got it", "ok", "k", "kk", "umkay", "sounds good", "indeed", "no problem", "not a problem", "okay", "yess", "yesss", "yas", "good", "so far, so good", "so far so good"];
...
yesOrNo = function(txt) {
  ...
  if (txt.length > 12 ) { // response over 15 char is likely a question
    return null;
