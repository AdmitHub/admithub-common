...
yesOrNo = function(txt) {
  ...
  if (_.contains(["yes", "yeah", "y", "ya", "yea", "yup", "yep", "true", "sure", "right", "certainly", "gladly", "of course", "absolutely", "cool", "totally", "got it", "ok", "k", "sounds good", "indeed", "yes please" , "ready", "okay", "ready", "yess", "yesss", "yas"], txt)) {
    return true;
  } else if (_.contains(["no", "n", "nope", "false", "na", "not", "no way", "pass", "nah", "nay", "no thanks", "no please"], txt)) {
    return false;
  }
