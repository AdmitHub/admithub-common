...
yesOrNo = function(txt) {
  if (_.contains(["yes", "yeah", "y", "ya", "yea", "yup", "yep", "true", "sure", "alright", "certainly", "gladly", "of course", "absolutely", "cool", "totally"], txt.toLowerCase())) {
    return true;
  } else if (_.contains(["no", "n", "nope", "false", "na", "not", "no way", "pass"], txt.toLowerCase())) {
    return false;
  }
