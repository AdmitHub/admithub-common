...
yesOrNo = function(txt) {
  ...
  if (_.contains(["yes", "yeah", "y", "ya", "yea", "yup", "yep", "true", "sure", "right", "certainly", "gladly", "of course", "absolutely", "cool", "totally", "got it", "ok", "k", "sounds good", "indeed", "yes please"], txt)) {
    return true;
